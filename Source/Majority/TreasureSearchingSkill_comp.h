...
protected:
	...
	// --- ÇÂÓÊÎÂÛÅ ÝÔÔÅÊÒÛ (Íàñòðàèâàþòñÿ â Blueprint) ---
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Audio|Treasure")
	USoundCue* SoundCuePoor;   // Äëÿ Common

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Audio|Treasure")
	USoundCue* SoundCueGood;   // Äëÿ Uncommon, Rare, Epic

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Audio|Treasure")
	USoundCue* SoundCueGreat;  // Äëÿ Legendary
